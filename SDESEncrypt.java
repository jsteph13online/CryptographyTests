...
Prompt: Simplified DES Algorithm - 4 round*/
...
public class SDESEncrypt {
   ...
   public static void main(String[] args){
      ...
      System.out.println("Input 12-bit Integer: " + plaintext + " Input 9-bit Key: " + key); 
      ...
      for (int round = 1; round < ROUNDS; round++)
      {
         ...
         output = encryptRound(intToBits(output, PLAINTEXT_BITS), keyString, round);
      }
      
      System.out.println("CipherText: " + output);
      System.out.println("CipherText Bit String: " + intToBits(output, PLAINTEXT_BITS));
   
   }
   
   // METHOD: A single round of encryption of a given bit string, given a 9-bit key and a round (0-3)
   public static int encryptRound(String ptString, String key, int round){
